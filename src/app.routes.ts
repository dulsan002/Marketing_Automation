...
import { AnalyticsComponent as MapAnalyticsComponent } from './pages/map/analytics/analytics.component';
...
import { AnalyticsComponent as AbmAnalyticsComponent } from './pages/abm/analytics/analytics.component';
...
import { AnalyticsComponent as EventsAnalyticsComponent } from './pages/events/analytics/analytics.component';
import { NewCampaignComponent } from './pages/map/new-campaign/new-campaign.component';
import { WorkflowBuilderComponent } from './pages/map/workflows/new-workflow/new-workflow.component';
...
export const APP_ROUTES: Routes = [
  ...
  },
  {
    ...
    data: { title: 'Create New Campaign', description: 'Build your new campaign step-by-step.'}
  },
  { 
    path: 'map/workflows', 
  ...
  },
  {
    ...
    data: { title: 'Workflow Builder', description: 'Design an automation workflow.'}
  },
  { 
  ...
  },
  {
    ...
    data: { title: 'Create Segment', description: 'Build a dynamic audience segment.'}
  },
  {
    path: 'map/prospect-segments/:id',
    component: NewSegmentComponent,
    data: { title: 'Edit Segment', description: 'Edit an existing audience segment.'}
  },
  { 
