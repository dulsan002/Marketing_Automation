          ...
          <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div class="relative">
                  ...
                  <input type="text" id="name" formControlName="name" class="w-full pl-10 pr-3 py-3 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                </div>
              </div>
              <div>
                ...
                <div class="relative">
                  ...
                  <input type="email" id="email" formControlName="email" class="w-full pl-10 pr-3 py-3 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input type="text" id="company" formControlName="company" class="w-full pl-10 pr-3 py-3 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
              </div>
            </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <select id="event" formControlName="eventId" class="appearance-none w-full pl-10 pr-10 py-3 rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500">
