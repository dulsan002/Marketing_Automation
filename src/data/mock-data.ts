...
export const MOCK_CAMPAIGNS: Campaign[] = [
    { id: 'cmp_1', name: 'Q4 Product Launch', type: 'Email', status: 'paused', sent: 7893, openRate: 20.5, ctr: 20.5, description: 'Launch campaign for Q4', senderName: 'Marketing Team', senderEmail: 'marketing@example.com', subject: 'Introducing our new Q4 Lineup!', body: '<p>Check out our new products...</p>', segmentId: 'All Active Customers' },
    { id: 'cmp_2', name: 'Enterprise Cloud Webinar Series', type: 'Social Post', status: 'completed', sent: 33824, openRate: 17.7, ctr: 20.8, description: 'Promotion for cloud webinar', platform: 'LinkedIn', text: 'Join our cloud webinar!', segmentId: 'VIP Members' },
    { id: 'cmp_3', name: 'SMB Nurture Campaign', type: 'Email', status: 'draft', sent: 29854, openRate: 26.1, ctr: 14.4, description: 'Nurture sequence for SMBs', senderName: 'Sales Team', senderEmail: 'sales@example.com', subject: 'Grow your business', body: '<p>Tips for growth...</p>', segmentId: 'Newsletter Subscribers' },
    { id: 'cmp_4', name: 'Digital Transformation Summit', type: 'Email', status: 'draft', sent: 33818, openRate: 36.8, ctr: 23.4, description: 'Summit invitation', senderName: 'Events Team', senderEmail: 'events@example.com', subject: 'Join us at the summit', body: '<p>Register now...</p>', segmentId: 'All Active Customers' },
    { id: 'cmp_5', name: 'Year-End Promotion', type: 'Social Post', status: 'completed', sent: 49758, openRate: 37.7, ctr: 12.8, description: 'End of year sale', platform: 'Facebook', text: '50% off everything!', segmentId: 'Newsletter Subscribers' },
    { id: 'cmp_6', name: 'Customer Success Stories', type: 'Email', status: 'active', sent: 49343, openRate: 28.8, ctr: 10.3, description: 'Sharing success stories', senderName: 'Success Team', senderEmail: 'success@example.com', subject: 'See how others succeed', body: '<p>Success stories...</p>', segmentId: 'VIP Members' },
    { id: 'cmp_7', name: 'Industry Insights Newsletter', type: 'Offline', status: 'paused', sent: 32876, openRate: 18.2, ctr: 12.5, description: 'Quarterly print newsletter', title: 'Industry Insights Q3', details: 'Print and mail to premium accounts', segmentId: 'VIP Members' },
];
...
export const MOCK_WORKFLOW_NODES_CATALOG: PaletteNode[] = [
    ...
    { type: 'FlowControl', subType: 'A/B Split Test', description: 'Split traffic 50/50', icon: '<path stroke-linecap="round" stroke-linejoin="round" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4" />' },
